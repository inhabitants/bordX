...
const tweetTypes = [
    { emoji: '👎', type: 'Um total escroto' },
    { emoji: '🎩', type: 'Sarcastico' },
    { emoji: '🌤️', type: 'Otimista iludido' },
    { emoji: '🔥', type: 'Controverso' },
    { emoji: '🤩', type: 'Animado demais' },
    { emoji: '🧠', type: 'Sagaz' },
    { emoji: '🏴‍☠️', type: 'Radical da liberdade' },
    { emoji: '🤣', type: 'Humoristico' },
    { emoji: '🙄', type: 'Passivo agressivo' }
];
    ...
    if (inputEl) {
        addGPTButton(toolBarEl, async (type, topic) => {
            ...
            if (text) {
                ...
                }, 500); // Adicionado atraso para atualização do DOM
            } else {
                showErrorButton(toolBarEl);
            }
        });
...
// O restante do código, incluindo a definição de findClosestInput, addGPTButton, generateText, setInputText, etc., permanece inalterado.
